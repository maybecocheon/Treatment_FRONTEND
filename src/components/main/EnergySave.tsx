            ...
            <div className="flex flex-col gap-4 py-2">
                <div className="flex flex-col gap-0.5">
                    <div className="flex justify-between items-end px-1 text-[9px] font-bold">
                        <span className="text-muted uppercase">기존</span>
                        <span className="text-muted">{costData?.existingCost.toLocaleString()}원</span>
                    </div>
                ...
                <div className="flex flex-col gap-0.5">
                    <div className="flex justify-between items-end px-1 text-[9px] font-bold">
                        <span className="text-success uppercase">AI 최적</span>
                        <span className="text-success">{costData?.optimizationCost.toLocaleString()}원</span>
                    </div>
                    <div className="w-full h-2 bg-success-bg rounded-full overflow-hidden">
                        <div
                            className="h-full bg-success shadow-[0_0_8px_rgba(16,185,129,0.3)] transition-all duration-1000 ease-out"
