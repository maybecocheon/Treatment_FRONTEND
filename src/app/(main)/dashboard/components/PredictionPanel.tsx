    ...
    <>
      <div className="flex-1 relative">
        ...
        <div className="glass backdrop-blur-xl rounded-3xl p-4 h-full flex flex-col overflow-hidden">
          ...
          <ChartPanel error={error} isLoading={isLoading} onClick={loadPredictionData} onOpen={() => setIsModalOpen(true)} data={filteredChartData} labels={["실제 수요", "예측 수요"]} mode="prediction" />
        </div>
      </div>
