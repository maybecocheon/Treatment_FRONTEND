...
export default function Dashboard() {
    ...
    const { treatment, loadTreatment, isLoading: isTreatmentLoading, isFetching: isTreatmentFetching } = useTreatment();
    const { checkLevelRisk, isLoading: isPredictionLoading, isFetching: isPredictionFetching } = useAllPrediction();
        ...
        <div className="h-full flex flex-col xl:grid xl:grid-cols-12 gap-4">
            ...
            <div className="h-full xl:col-span-2 flex flex-col">
                {isLoading || isPredictionLoading ? (
                    ...
                    <div className="h-full flex flex-col gap-4 p-5 glass border-danger/20 rounded-2xl relative">
                        <FetchingSpinner isFetching={isFetching || isPredictionFetching} />
                        <h3 className="font-black text-danger px-1 flex items-center gap-2">
                            <AlertTriangle size={20} /> 위험 관제 시스템
                        </h3>
                        <div className="flex-1 flex flex-col gap-4">
                            <RiskDetailPanel riskMetrics={riskMetrics} isFetching={isFetching} />
            ...
            <div className="h-full xl:col-span-3 flex flex-col">
                {isLoading || isTreatmentLoading ? (
                    ...
                    <div className="h-full xl:col-span-3 flex flex-col gap-3 glass border-success/20 p-5 rounded-2xl relative">
                        <FetchingSpinner isFetching={isFetching || isTreatmentFetching} />
