...
export default function GuidePanels() {
    return (
        <div className="flex-1 flex flex-col rounded-2xl p-4 gap-3 bg-white backdrop-blur-sm border border-slate-200/50">
            <div className="flex flex-col sm:flex-row xl:flex-col items-center gap-2 w-full">
                {/* 1. 하루 정수 계획 */}
                <div className="w-full flex flex-col gap-2">
                    <h4 className="text-[13px] font-black text-blue-950 text-center uppercase opacity-70">최적화를 위한 하루 정수 계획</h4>
                    ...
                    <div className="flex items-center gap-2 p-4 rounded-lg bg-blue-50/50">
                        <div className="flex flex-col gap-1">
                            <div className="flex items-center gap-2">
                                ...
                                <p className="text-[13px] font-bold text-slate-700 leading-tight">유출량 예측 기반 충수</p>
                            </div>
                            <p className="text-[11px] text-slate-500 leading-normal font-medium">만수위 도달 전 손실 최소화 가동 (오버플로우 방지)</p>
                        </div>
                    </div>
                    <div className="flex items-center gap-2 p-4 rounded-lg bg-emerald-50/50">
                        <div className="flex flex-col gap-1">
                            <div className="flex items-center gap-2">
                                ...
                                <p className="text-[13px] font-bold text-slate-700 leading-tight">에너지 부하 분산 제어</p>
                            </div>
                            <p className="text-[11px] text-slate-500 leading-normal font-medium">평균 1~3대 펌프 운영으로 최적 효율 유지</p>
                        </div>
                    </div>
                </div>
            </div>
