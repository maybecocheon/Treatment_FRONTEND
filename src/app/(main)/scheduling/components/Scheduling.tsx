...
export default function Scheduling() {
    ...
    return (
        <>
            <div className="xl:col-span-8">
                <div className="flex flex-col gap-4 h-full">
                    ...
                    <div className="flex-1 grid grid-cols-1 md:grid-cols-12 gap-4 items-stretch">
                        <div className="md:col-span-4 flex flex-col justify-center gap-4 p-6 bg-slate-50 rounded-3xl border border-slate-200 border-dashed">
                            ...
                            <p className="text-sm text-slate-600 leading-relaxed font-medium">
                                단순 가동이 아닌, 실시간 부하를 분석하여 <span className="text-emerald-600 font-bold">최적의 펌프 조합</span>을 찾아냅니다.
                                비싼 시간대의 가동을 피하고 경부하 시간대에 에너지를 비축하는 것이 핵심입니다.
                            </p>
                            <div className="flex items-center gap-2 text-emerald-600 font-black text-xs uppercase tracking-tighter mt-2">
                        ...
                        <div className="md:col-span-8">
                            <PumpOptimization optimizationData={optimizationData} isLoading={isLoading} error={error} loadOptimization={loadOptimization} />
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        {/* Step 1: 분석 */}
                        <div className="group bg-white border border-slate-200 rounded-2xl p-6 transition-all hover:border-emerald-300 shadow-xs flex flex-col h-full">
                            <div className="flex items-start gap-3">
                                <div className="shrink-0 w-10 h-10 rounded-lg bg-slate-100 flex items-center justify-center text-slate-600 group-hover:bg-emerald-600 group-hover:text-white transition-colors">
                                    <Ruler size={20} />
                                </div>
                                <div className="flex flex-col">
                                    <span className="text-[9px] font-black text-emerald-600 uppercase tracking-widest">Logic 01</span>
                        ...
                        <div className="group bg-white border border-slate-200 rounded-2xl p-6 transition-all hover:border-emerald-300 shadow-xs flex flex-col h-full">
                            <div className="flex items-start gap-3">
                                ...
                                <div className="flex flex-col">
                                    <span className="text-[9px] font-black text-emerald-600 uppercase tracking-widest">Logic 02</span>
                        ...
                        <div className="group bg-white border border-slate-200 rounded-2xl p-6 transition-all hover:border-emerald-300 shadow-xs flex flex-col h-full">
                            <div className="flex items-start gap-3">
                                <div className="shrink-0 w-10 h-10 rounded-lg bg-emerald-600 flex items-center justify-center text-white">
                                    <ShieldAlert size={20} />
                                </div>
                                <div className="flex flex-col">
                                    <span className="text-[9px] font-black text-emerald-600 uppercase tracking-wideste">Safety Lock</span>
                                    <h4 className="text-base font-black text-slate-800 tracking-tight">동작 안정성 가이드</h4>
                                </div>
                            </div>
                            <div className="flex flex-col gap-1 text-left">
                                <ul className="mt-3 space-y-2 text-slate-600 text-[12px] font-medium">
                                    <li className="flex items-start gap-2">
                                        <div className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 shrink-0" />
                                        <span>최소 가동 <strong className="text-emerald-600">1시간</strong> 준수 (펌프 보호)</span>
                                    </li>
                                    <li className="flex items-start gap-2">
                                        <div className="mt-1.5 w-1 h-1 rounded-full bg-rose-600 shrink-0" />
            ...
            <div className="xl:col-span-4 border-t pt-6 border-slate-200 xl:border-t-0 xl:pt-0 xl:border-l xl:pl-4">
                <MainTrend optimizationData={optimizationData} isLoading={isLoading} error={error} loadOptimization={loadOptimization} />
            </div>
        </>
    )
}
