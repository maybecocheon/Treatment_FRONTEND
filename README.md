...
AI 기반 수자원 관리 시스템으로, 미래 수돗물 수요를 정밀하게 예측하고 펌프 가동을 최적화하여 에너지 효율을 극대화하는 솔루션입니다.
...
https://github.com/user-attachments/assets/93f3e0e3-6cc1-4dc0-ab31-5975a10799a2
